"""
Pytest configuration for TikTok App tests
Pytest configuration for TikTok App tests
"""
...
def pytest_addoption(parser):
    ...
    parser.addoption(
        ...
        default="en", 
        choices=["en", "zh"],
        help="Language for testing (en/zh)"
    )
...
def setup_screenshot_management(language):
    """Setup screenshot management for TikTok App tests"""
    ...
    Log.info(f"Setting up screenshot management for TikTok App tests (Language: {language})")
    ScreenshotUtils.clear_screenshot_directory(app_package)
    
    yield
    
    # Cleanup after test session
    Log.info("Cleaning up screenshot management for TikTok App tests")
